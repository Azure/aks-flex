...
// 	protoc        v6.33.4
// source: flex-plugin/api/api.proto
...
const file_flex_plugin_api_api_proto_rawDesc = "" +
	"\n" +
	"\x19flex-plugin/api/api.proto\x12\x03api\x1a\x19google/protobuf/any.proto\".\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x0eDeleteResponseB+Z)github.com/Azure/aks-flex/flex-plugin/apib\beditionsp\xe9\a"
