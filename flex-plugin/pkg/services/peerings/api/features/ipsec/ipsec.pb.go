...
// 	protoc        v6.33.4
// source: flex-plugin/pkg/services/peerings/api/features/ipsec/ipsec.proto
...
const file_flex_plugin_pkg_services_peerings_api_features_ipsec_ipsec_proto_rawDesc = "" +
	"\n" +
	"@flex-plugin/pkg/services/peerings/api/features/ipsec/ipsec.proto\x12\x05ipsec\"K\n" +
	"\x06Config\x12\x1b\n" +
	"\tremote_ip\x18\x01 \x01(\tR\bremoteIp\x12$\n" +
	"\x0epre_shared_key\x18\x02 \x01(\tR\fpreSharedKeyBPZNgithub.com/Azure/aks-flex/flex-plugin/pkg/services/peerings/api/features/ipsecb\beditionsp\xe9\a"
