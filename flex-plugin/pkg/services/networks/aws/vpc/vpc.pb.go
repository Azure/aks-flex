...
// 	protoc        v6.33.4
// source: flex-plugin/pkg/services/networks/aws/vpc/vpc.proto
...
const file_flex_plugin_pkg_services_networks_aws_vpc_vpc_proto_rawDesc = "" +
	"\n" +
	"3flex-plugin/pkg/services/networks/aws/vpc/vpc.proto\x12\x10networks.aws.vpc\x1a\x19flex-plugin/api/api.proto\x1a>flex-plugin/pkg/services/networks/api/features/vnet/vnet.proto\"\xa0\x01\n" +
	"\aNetwork\x12)\n" +
	...
	"routeTable\x12%\n" +
	"\x0esecurity_group\x18\x05 \x01(\tR\rsecurityGroupBEZCgithub.com/Azure/aks-flex/flex-plugin/pkg/services/networks/aws/vpcb\beditionsp\xe9\a"
