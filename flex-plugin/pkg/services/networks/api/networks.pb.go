...
const file_flex_plugin_pkg_services_networks_api_networks_proto_rawDesc = "" +
	"\n" +
	"4flex-plugin/pkg/services/networks/api/networks.proto\x12\bnetworks\x1a\x19flex-plugin/api/api.proto2\xe7\x01\n" +
	"\bNetworks\x12K\n" +
	...
	"\x06Delete\x12\x12.api.DeleteRequest\x1a\x13.api.DeleteResponse\"\x00BAZ?github.com/Azure/aks-flex/flex-plugin/pkg/services/networks/apib\beditionsp\xe9\a"
